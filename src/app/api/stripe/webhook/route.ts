...
// Route Handler no runtime Edge — assinatura Request/Response padrão da Web
// API, compatível com `stripe.webhooks.constructEventAsync` (que usa Web
// Crypto, sem depender do módulo `crypto` do Node).
